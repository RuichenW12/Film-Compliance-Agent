...
|---|---|
| Fixture | `tests/fixtures/scripts/e2e-30min-public-security.md` |
| Title | `先挂电话` |
| Source structure | 1 episode, 30 minutes, 15 scenes |
| Gemini intake | Chinese tags, complete Synopsis, episode plan, investment band |
| Accepted suggestion | 15 episodes × 2 minutes; below CNY 300,000 |
| Classification | Class 1 |
| Co-review | Required |
| Subject | Public security |
| Findings | 9 locatable findings in the accepted run |
...
Do not memorize or promise `15 × 2` or exactly nine findings in the voice-over.
...
private customer data, or the 70-minute judicial fixture for the final take.
...
| 1:05–1:40 | Show title, source structure, Synopsis, tags, episode plan, and investment band. Edit one field. |
...
- the single editable field demonstrated at confirmation;
...
- at least five locatable public-security findings;
...
| Result is not Class 1/co-review | Stop and inspect the confirmed Synopsis/tags; do not fake the intended route. |
